...
class DatatableService
{
  ...
  protected static function deleteBtn($id, $name): string
  {
  ...
  protected static function btn($route, $hint, $icon = "Layout/Layout-top-panel-5.svg"): string
  {
    $svg = file_get_contents("assets/media/svg/icons/" . $icon);
  ...
  protected static function naviItem($url, $type, $onClick = ""): string
  {
    switch ($type) {
      case 'delete':
        $icon = "la la-trash";
